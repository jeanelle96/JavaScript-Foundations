...
function mortgageCalculator (principal, interestRate, years, creditScore){
    if(creditScore > 740){
        ...
        interestRate = interestRate + (0.05/100);
    }
    console.log(interestRate);
}
mortgageCalculator(200000, 0.05, 30, 760);
...
function mortgageCalculator (principal, interestRate, years){
        ...
        console.log( name + ", with an intrest rate of " + monthlyInterestRate + ", your monthly rate is $" + monthlyRate);  
    }
